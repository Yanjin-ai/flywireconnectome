...
def main():
    ...
    obs = (
        ...
        "• Hub neurons span multiple motor modules (wing/flight, leg, abdominal) "
        "and include DNg02 — a documented flight-motor population that sets "
        "wingbeat amplitude via a population code (Schnell et al. 2022): a known "
        "controller sits inside the invariant backbone.\n"
